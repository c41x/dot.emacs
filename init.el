...
;; (defun mbox:overlays-in-this-line ()
;;   (overlays-in (line-beginning-position) (line-end-position)))

;; (defun mbox:line (line column width frame-type text)
;;   (save-excursion
;;     (goto-line line)
;;     ;;(mapc 'mbox:delete-if-box (mbox:overlays-in-this-line))
...
;; 	  (right (point))
;; 	  (boxes 0))
;;       (mapc 'mbox:hide-overlay (mbox:overlays-in-this-line))
;;       ;; find left position
...
;; 					    (make-string 1 ?\║))))))
;;       (mapc 'mbox:show-overlay (mbox:overlays-in-this-line))
;;       ;; return overlay
;;       ov)))
